...
Metallic is a minimal library for meta-learning research based on `PyTorch <https://github.com/pytorch/pytorch>`_ and `higher <https://github.com/facebookresearch/higher>`_.
